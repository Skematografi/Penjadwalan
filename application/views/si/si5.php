            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo site_url(); ?>Si_kelola/tambah_data" method="post" autocomplete="off">
                         <div class="row">
                            <div class="col">
                              <input type="text" name="link" id="link" value="Si/si_5" hidden>
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="kelas" id="kelas" required>
                                      ...
                                      <option><?php echo "Sistem Informasi 5 ".$row['gelombang']; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <?php echo anchor('Si_kelola/edit_5/'.$id, "<i class='far fa-edit' style='size:2px;color:blue; margin-right:5px;'> Edit</i>");
                                ?>
                                <?php echo anchor('Si_kelola/hapus/'.$id.'/Si/si_5',"<i class='far fa-trash-alt' style='size:2px;color:red;'> Hapus</i>");
                                ?>
                              </td>
                            </tr>
                            <?php endforeach ?>
