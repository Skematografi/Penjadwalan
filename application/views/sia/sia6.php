                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="kelas" id="kelas" required>
                                      ...
                                      <option><?php echo "S.I. Akuntansi 6 ".$row['gelombang']; ?></option>
                                      <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <?php echo anchor('Si_kelola/edit_sia6/'.$id, "<i class='far fa-edit' style='size:2px;color:blue; margin-right:5px;'> Edit</i>");
                                ?>
